...
const KEYFRAMES := [
	[8.0, 0.95, Color(1.0, 0.95, 0.82), 0.0, Color(0.34, 0.4, 0.48), Color(0.42, 0.45, 0.5), 0.014, 0.4, 46.0, 28.0],
	[17.0, 0.85, Color(1.0, 0.9, 0.75), 0.0, Color(0.32, 0.36, 0.44), Color(0.4, 0.42, 0.47), 0.016, 0.35, 44.0, 26.0],
